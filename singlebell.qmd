...
description-meta: "SingleBell is an iPhone kettlebell app, on the App Store: the day's practice dealt fresh each morning, the classic protocols, a builder for your own sessions, and the running practice on your Lock Screen and Apple Watch. No account, no analytics, and no network code — it collects nothing."
...
[Download on the App Store →](https://apps.apple.com/app/singlebell-kb-practice/id6805588015){.pill .store} [iPhone · iOS 18 or later]{.pill}
:::
:::
...
from what you have already done: a warm-up chosen for the day's lift, a kettlebell
complex around that lift — clean & press, one-arm swings, or the snatch — and a
bodyweight finisher, chalked on the board with an honest estimate of what it costs. Short
is about twenty minutes, Standard about thirty-five. The lift you have practised least
recently leads, and a snatch day waits until you have logged a swing day. Rest when you
decide to: the app never declares a rest day, and the week under the card shows what it
has had. Tap Light, Right or Heavy when you finish and the next board led by that lift
adds or drops a set. The day is dealt once and holds until midnight — finishing it
resolves the card in place rather than moving it under your feet. Either side of Start
are two doors: open the day in the Builder and make it yours, or keep it in your Library
as dealt.
...
rounds on the clock. The same three lines open Today's Practice, under one line chosen
for the day's lift.
...
Quick and the Dead as snatches alone, tighten the Axe to every thirty seconds, run the
Complex for thirty minutes or on ninety-second rounds, choose the Humane Burpee's set
count.

**Warm up first.** Every board carries the switch, on until you turn it off. Simple &
Sinister warms up on its own trio. Everything else takes a round dealt for what follows —
the world's greatest stretch before anything that goes overhead, good mornings before
swings, jumping jacks otherwise, the trio under it — for two rounds: each move its own
station on the clock, or one block marked down with a tap on a board. Never more than
seven minutes in front of a classic.
...
- **your settings** — the sound switches and cue volume, whether you have a pull-up bar,
  ...
  how you last set up each classic on its board (Simple & Sinister's pace, the Rite's
  pull, the Complex's clock), whether you have put the "Start here" card away, and
  whether the app has explained "/side" to you once;
